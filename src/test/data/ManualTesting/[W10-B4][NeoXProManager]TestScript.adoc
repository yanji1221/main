...
. Check that all people in the list are having their birthday in current month(November) and do not include people that are before current date(17th November).
. Type `add n/Sharon Chiew b/1990/11/27`
. Close the application and restart it.
. Sharon Chiew will be shown in the list
