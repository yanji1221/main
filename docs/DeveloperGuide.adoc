...
==== Add Profile Page
The profile page parameter is facilitated by the class `ProfilePage` of which the class `Person` consists. As profile page is an optional parameter, a `Person` can be linked to 0 or 1 `ProfilePage` object. +
