...
* `UI Component:` +
PersonCard uses ReadOnlyPerson to create labels of each parameter. New parameter: Birthday, should be added to be included
...
[discrete]
=== Use case: Add event associated with a person

*MSS*

1.  User requests to list persons
2.  Application shows a list of persons
3.  User requests to add in an event associate with a specific person in the list
4.  Application adds the event
+
Use case ends.
