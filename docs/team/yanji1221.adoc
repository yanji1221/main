...
until all colours in the database of NeoxPro(around 33 types of colours) had been used up.
...
yellow colour text will show if command fails. +
...
Those codes are not collated, however they can be a huge portion as a total.
