...
* Write additional tests to increase coverage by 1.4% (Pull requests https://github.com/CS2103AUG2017-W10-B4/main/pull/89, https://github.com/CS2103AUG2017-W10-B4/main/pull/99)
