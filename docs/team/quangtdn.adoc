...
Let users easily access social media and improve experience. Employers can also make use of this feature to quickly access candidates' CV or profile page. 
...
* Fix bugs due to merge conflicts for team (Pull requests https://github.com/CS2103AUG2017-W10-B4/main/pull/70, https://github.com/CS2103AUG2017-W10-B4/main/pull/45)
* Wrote additional tests to increase coverage by 1.4% (Pull requests https://github.com/CS2103AUG2017-W10-B4/main/pull/89, https://github.com/CS2103AUG2017-W10-B4/main/pull/99)
