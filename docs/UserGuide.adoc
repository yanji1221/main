...
=== Locating persons by phone number: `findNumber`

Finds persons whose phone numbers include the numbers. +
Format: `findNumber NUMBERS`

****
* Only the phone number is searched.
* Partial phone number sequences will be matched e.g. `876534` will match `87654321`
****

Examples:

* `findNumber 87654321` +
Returns persons with the phone number `87654321` (can return multiple persons if it is a land line).
* `findNumber 876543` +
Returns any person whose phone number contains the sequence `876543`.
